...
const GUEST_STEPS: Step[] = [
  {
    ...
    title: "ابحث",
    description:
      "حدِّد المدينة، التواريخ، وعدد الضيوف. استخدم الفلاتر للوصول لبيت العطلات الذي يناسبك تماماً.",
    icon: Search,
  },
  {
    number: "2",
  ...
  },
  {
    ...
    title: "استمتع",
    description:
      "ستصلك تفاصيل مكان الإقامة والمضيف بعد التأكيد. استمتع بإقامتك ودع لنا الباقي.",
    icon: Smile,
  },
];
...
const HOST_STEPS: Step[] = [
  {
    ...
    title: "سجِّل كمضيف",
    description:
      "أنشئ حساب مضيف عبر النموذج المختصر. نبدأ حالياً ببيوت العطلات، ومسار الفنادق سيُفتح لاحقاً.",
    icon: UserPlus,
  },
  {
    number: "2",
  ...
  },
  {
    ...
    description:
      "أدخِل تفاصيل المكان، الصور، والأسعار. أضف قواعد إقامتك وسياسة الإلغاء التي تناسبك.",
    icon: Home,
  },
  {
    number: "4",
