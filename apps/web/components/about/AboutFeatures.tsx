...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "بيوت عطلات بأسلوب Airbnb (وصف غرفة بغرفة) وفنادق بأسلوب Booking (إدارة دقيقة للوحدات). كلٌّ بمنطقه الخاص دون خلط.",
  },
  {
    icon: Wallet,
  ...
  },
  {
    ...
    title: "تحقُّق صارم",
    description:
      "كل مضيف يمر بإجراءات KYC قبل النشر. كل مكان إقامة يُراجَع يدوياً. التحقُّق ليس شعاراً—هو إجراء فعلي.",
  },
  {
    icon: Eye,
    title: "شفافية كاملة",
