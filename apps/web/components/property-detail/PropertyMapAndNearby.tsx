...
export function PropertyMapAndNearby({
  approximateAddress,
  nearby,
}: {
  ...
  return (
    <section aria-labelledby="property-map-heading">
      <h2 id="property-map-heading" className="text-xl font-bold text-charcoal">
        الموقع والمعالم القريبة
      </h2>
      ...
      <p className="mt-1 text-xs text-muted">
        * الموقع الدقيق يُعرض بعد تأكيد الحجز.
      </p>
