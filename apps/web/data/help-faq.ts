...
export const HELP_CATEGORIES: HelpCategory[] = [
  {
    ...
    label: "الحجز",
    description: "كيف تبحث، تختار مكان الإقامة المناسب، وتؤكِّد الحجز.",
  },
  {
    id: "payment",
    iconName: "Wallet",
...
export const HELP_FAQ: HelpFaqItem[] = [
  // -------- Booking --------
  {
    id: "how-to-book",
    categoryId: "booking",
    question: "كيف أحجز بيت عطلات أو فندقاً عبر سُكنى؟",
    answer:
      "ابحث عن المدينة أو نوع مكان الإقامة، اختر تواريخ الإقامة وعدد الضيوف، ثم اضغط على البطاقة لمراجعة التفاصيل. اضغط زر الحجز، أكمل بياناتك، وادفع بإحدى الطرق المتاحة. ستصلك رسالة تأكيد فوراً.",
  },
  {
    id: "advance-booking",
    categoryId: "booking",
    ...
    answer:
      "نعم، يمكنك الحجز قبل تاريخ الوصول حتى 12 شهراً. بعض المضيفين يحدِّدون قواعد خاصة لفترات الإقامات الطويلة (أكثر من 30 ليلة) وستظهر هذه القواعد على صفحة مكان الإقامة.",
  },
  {
    id: "guests-count",
    categoryId: "booking",
    ...
    answer:
      "كل مكان إقامة له حدّ أقصى للضيوف. إذا تجاوزت هذا الحد، النظام لن يسمح بإكمال الحجز. لإضافة ضيوف إضافيين تواصل مع المضيف عبر الرسائل بعد تأكيد الحجز.",
  },
  // -------- Payment --------
  {
    id: "payment-methods",
  ...
  // -------- Cancellation --------
  {
    ...
    answer:
      "هناك 3 سياسات يختارها المضيف: مرنة (إلغاء مجاني قبل 24 ساعة)، متوسطة (قبل 5 أيام)، صارمة (لا استرداد بعد التأكيد). السياسة المحددة تظهر بوضوح على صفحة مكان الإقامة قبل الحجز.",
  },
  {
    id: "refund-time",
    categoryId: "cancellation",
  ...
  // -------- Safety --------
  {
    ...
    categoryId: "safety",
    question: "كيف تتأكَّدون من أن بيوت العطلات حقيقية؟",
    answer:
      "كل مضيف يمر بعملية تحقُّق (KYC) قبل عرض بيوت عطلاته. نطلب هوية شخصية، إثبات ملكية أو تفويض، وللشركات: سجلاً تجارياً ورخصة. الإعلانات تُراجَع يدوياً قبل النشر.",
  },
  {
    id: "data-privacy",
    categoryId: "safety",
    ...
    answer:
      "بياناتك مشفَّرة أثناء النقل (TLS) وعند التخزين. أرقام الهواتف الكاملة لا تظهر للمستخدمين الآخرين. عناوين أماكن الإقامة الدقيقة تظهر فقط بعد تأكيد الحجز.",
  },
  {
    id: "fraud-prevention",
    categoryId: "safety",
    ...
    answer:
      "أبلغنا فوراً عبر زر \"الإبلاغ\" في صفحة مكان الإقامة أو من خلال صفحة /contact. لا تدفع أبداً خارج المنصة—كل المعاملات لا تكون محمية إلا داخل سُكنى.",
  },
  // -------- Account --------
  {
    id: "create-account",
  ...
  // -------- Communication --------
  {
    ...
    answer:
      "بعد تأكيد الحجز يفتح لك صندوق رسائل مباشر مع المضيف. قبل تأكيد الحجز لا يمكن إرسال رسائل لأسباب أمنية—جميع الأسئلة العامة تجيب عنها صفحة مكان الإقامة.",
  },
  {
    id: "support-response",
    categoryId: "communication",
